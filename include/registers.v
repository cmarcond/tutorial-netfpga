...
`define ESTIMATION_BLOCK_ADDR_WIDTH     16
`define ESTIMATION_REG_ADDR_WIDTH       7
...
`define ESTIMATION_BLOCK_ADDR     16'h0003
...
`define ESTIMATION_PKT_EN      7'h0
`define ESTIMATION_TIMESTAMP1  7'h1
`define ESTIMATION_TIMESTAMP2  7'h2
`define ESTIMATION_TIMESTAMP3  7'h3
`define ESTIMATION_TIMESTAMP4  7'h4
`define ESTIMATION_TIMESTAMP5  7'h5
`define ESTIMATION_TIMESTAMP6  7'h6
`define ESTIMATION_TIMESTAMP7  7'h7
`define ESTIMATION_TIMESTAMP8  7'h8
