#############################################################
#
# Perl register defines file for tutorial_router
#
#############################################################

package reg_defines_tutorial_router;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                RATE_LIMIT_0_ENABLE_REG
                RATE_LIMIT_0_SHIFT_REG
                RATE_LIMIT_1_ENABLE_REG
                RATE_LIMIT_1_SHIFT_REG
                RATE_LIMIT_2_ENABLE_REG
                RATE_LIMIT_2_SHIFT_REG
                RATE_LIMIT_3_ENABLE_REG
                RATE_LIMIT_3_SHIFT_REG
                ...
                ESTIMATION_PKT_EN_REG
                ESTIMATION_TIMESTAMP1_REG
                ESTIMATION_TIMESTAMP2_REG
                ESTIMATION_TIMESTAMP3_REG
                ESTIMATION_TIMESTAMP4_REG
                ESTIMATION_TIMESTAMP5_REG
                ESTIMATION_TIMESTAMP6_REG
                ESTIMATION_TIMESTAMP7_REG
                ESTIMATION_TIMESTAMP8_REG
                OQ_QUEUE_0_CTRL_REG
...
sub RATE_LIMIT_0_BASE_ADDR ()    { 0x2000300; }
sub RATE_LIMIT_1_BASE_ADDR ()    { 0x2000340; }
sub RATE_LIMIT_2_BASE_ADDR ()    { 0x2000380; }
sub RATE_LIMIT_3_BASE_ADDR ()    { 0x20003c0; }
sub EVT_CAP_BASE_ADDR ()         { 0x2000400; }
sub ESTIMATION_BASE_ADDR ()      { 0x2000700; }
...
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_0_ENABLE_REG ()   { 0x2000300;}
sub RATE_LIMIT_0_SHIFT_REG ()    { 0x2000304;}

# Name: rate_limiter (RATE_LIMIT_1)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_1_ENABLE_REG ()   { 0x2000340;}
sub RATE_LIMIT_1_SHIFT_REG ()    { 0x2000344;}

# Name: rate_limiter (RATE_LIMIT_2)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_2_ENABLE_REG ()   { 0x2000380;}
sub RATE_LIMIT_2_SHIFT_REG ()    { 0x2000384;}

# Name: rate_limiter (RATE_LIMIT_3)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_3_ENABLE_REG ()   { 0x20003c0;}
sub RATE_LIMIT_3_SHIFT_REG ()    { 0x20003c4;}

# Name: event_capture (EVT_CAP)
# Description: Event Capture Registers
# File: lib/verilog/core/event_capture/xml/event_capture.xml
sub EVT_CAP_ENABLE_CAPTURE_REG ()      { 0x2000400;}
sub EVT_CAP_SEND_PKT_REG ()            { 0x2000404;}
sub EVT_CAP_DST_MAC_HI_REG ()          { 0x2000408;}
sub EVT_CAP_DST_MAC_LO_REG ()          { 0x200040c;}
sub EVT_CAP_SRC_MAC_HI_REG ()          { 0x2000410;}
sub EVT_CAP_SRC_MAC_LO_REG ()          { 0x2000414;}
sub EVT_CAP_ETHERTYPE_REG ()           { 0x2000418;}
sub EVT_CAP_IP_DST_REG ()              { 0x200041c;}
sub EVT_CAP_IP_SRC_REG ()              { 0x2000420;}
sub EVT_CAP_MONITOR_MASK_REG ()        { 0x2000424;}
sub EVT_CAP_SIGNAL_ID_MASK_REG ()      { 0x2000428;}
sub EVT_CAP_NUM_EVTS_DROPPED_REG ()    { 0x200042c;}
sub EVT_CAP_UDP_SRC_PORT_REG ()        { 0x2000430;}
sub EVT_CAP_UDP_DST_PORT_REG ()        { 0x2000434;}
sub EVT_CAP_OUTPUT_PORTS_REG ()        { 0x2000438;}
sub EVT_CAP_RESET_TIMERS_REG ()        { 0x200043c;}
sub EVT_CAP_TIMER_RESOLUTION_REG ()    { 0x2000440;}
sub EVT_CAP_NUM_EVT_PKTS_SENT_REG ()   { 0x2000444;}
sub EVT_CAP_NUM_EVTS_SENT_REG ()       { 0x2000448;}

# Name: estimation (ESTIMATION)
# Description: Module to Do Estimation of Bottleneck
# File: projects/tutorial_router/include/estimation.xml
sub ESTIMATION_PKT_EN_REG ()       { 0x2000700;}
sub ESTIMATION_TIMESTAMP1_REG ()   { 0x2000704;}
sub ESTIMATION_TIMESTAMP2_REG ()   { 0x2000708;}
sub ESTIMATION_TIMESTAMP3_REG ()   { 0x200070c;}
sub ESTIMATION_TIMESTAMP4_REG ()   { 0x2000710;}
sub ESTIMATION_TIMESTAMP5_REG ()   { 0x2000714;}
sub ESTIMATION_TIMESTAMP6_REG ()   { 0x2000718;}
sub ESTIMATION_TIMESTAMP7_REG ()   { 0x200071c;}
sub ESTIMATION_TIMESTAMP8_REG ()   { 0x2000720;}
